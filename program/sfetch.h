...
#define TOTAL_RAM (sys.totalram * sys.mem_unit) / MB / MB
#define FREE_RAM (sys.freeram * sys.mem_unit) / MB / MB
#define TOTAL_SWAP (sys.totalswap * sys.mem_unit) / MB / MB
#define FREE_SWAP (sys.freeswap * sys.mem_unit) / MB / MB
